  ...
  return (
    <section className='w-full h-[794px] flex items-center justify-center bg-[url(../../assets/hero/hero.png)] bg-center bg-no-repeat'>
        <div className='text-center mx-auto flex flex-col'>
            <h1 className='text-6xl font-semibold text-[#eaa18e] md:h-16 bg-opacity-25 rounded md:mt-15 mt-40'>t-shirts in preparation</h1>
            ...
            <span data-sumome-listbuilder-embed-id="3bf7c433b330618be83b64c1024e76b2b75d60baa782d225cab20fb49dca4fe1"></span>
        </div>
    </section>
  )
}