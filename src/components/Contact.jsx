...
export const Contact = () => {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center dark:text-white">Contact Us</h2>
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Want to send feedback about our presentation? Need details about our Business? Let us know.</p>
      ...
      <div>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center border-4 border-(--color-dark)-100">Send message</button>
      </form>
  </div>
</section>
  )
